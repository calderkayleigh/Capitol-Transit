...
class TrainTimesActivity: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        doAsync {
            ...
            val originStation = stationEntranceManager.retrieveStation(lat1, lon1)
            val trainTimes: List<TrainTime> = stationEntranceManager.retrieveTrainTimes(originStation)
